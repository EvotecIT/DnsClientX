...
namespace DnsClientX.Tests {
    public class CompareProvidersResolve(ITestOutputHelper output) {
        ...
        [InlineData("www.bücher.de", DnsRecordType.A, new[] { DnsEndpoint.Quad9, DnsEndpoint.Quad9ECS, DnsEndpoint.Quad9Unsecure })]
        ...
        [InlineData("1.1.1.1", DnsRecordType.PTR, new[] { DnsEndpoint.Quad9, DnsEndpoint.Quad9ECS, DnsEndpoint.Quad9Unsecure })]
        [InlineData("108.138.7.68", DnsRecordType.PTR, new[] { DnsEndpoint.Quad9, DnsEndpoint.Quad9ECS, DnsEndpoint.Quad9Unsecure })]
        [InlineData("sip2sip.info", DnsRecordType.NAPTR, new[] { DnsEndpoint.Quad9, DnsEndpoint.Quad9ECS, DnsEndpoint.Quad9Unsecure })]
