...
namespace DnsClientX.Tests {
    ...
    public class ConnectTimeoutDisposalTests {
        /// <summary>
        /// The wire TCP connector should dispose the socket when <c>ConnectAsync</c> exceeds the timeout.
        /// </summary>
        [Fact]
        public async Task ConnectAsync_ShouldDisposeSocketOnTimeout() {
            MethodInfo method = typeof(DnsWireResolveTcp).GetMethod(
                "ConnectAsync", BindingFlags.NonPublic | BindingFlags.Static)!;
